...
!!! tip
    Acese na aula [**05-Condicionais**](https://insper.github.io/SistemasHardwareSoftware/aulas/05-condicionais/) a explicação sobre as variantes da instrução `mov`
...
!!! tip
    Fique atento a chamadas de variáveis globais. Utilize o comando `x` para imprimir o conteúdo de um endereço. Veja mais em https://sourceware.org/gdb/current/onlinedocs/gdb.html/Memory.html
