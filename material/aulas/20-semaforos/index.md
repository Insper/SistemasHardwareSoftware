...
!!! example
    Marque abaixo as ordens de execução possíveis para as partes A, B, C e D.
...
!!! example
    Implemente (do zero) um programa que cria duas threads e as sincroniza usando *RDV*. Ambas deverão fazer um `print` antes e um depois do ponto de encontro.
